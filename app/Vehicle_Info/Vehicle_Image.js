...
const VehicleImages = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Upload a clear pictures of the front, rear and side of your car</Text>
      <TouchableOpacity style={styles.imageContainer} onPress={pickImage}>
        {image ? (
          <Image source={{ uri: image }} style={styles.image} />
        ) : (
          <Text style={styles.placeholderText}>Tap her to choose an image or Capture image</Text>
        )}
      </TouchableOpacity>
